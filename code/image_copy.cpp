...
void color_interpolation()
{
	...
	for( i = 0; i <2460 ; i = i+2)
		for( j = 5 ; j<3293; j = j+2)
		{
			...
			// Improved interpolation for R region
			if(i > 0 && j > 0 && i < 2458 && j < 3292)
			{
				r[i][j] = ( pic[i][j] + pic[i-2][j] + pic[i+2][j] + pic[i][j-2] + pic[i][j+2] ) / 5;
			}
		}
	...
	for( i = 1; i <2460 ; i = i+2)
		for( j = 5 ; j<3293; j = j+2)
        {
			...
			// Improved interpolation for G region
			if(i > 0 && j > 0 && i < 2458 && j < 3292)
			{
				g[i][j] = ( pic[i][j] + pic[i-2][j] + pic[i+2][j] + pic[i][j-2] + pic[i][j+2] ) / 5;
			}
		}
	...
	for( i = 0; i <2460 ; i = i+2)
		for( j = 6 ; j<3293; j = j+2)
		{
			...
			// Improved interpolation for E region
			if(i > 0 && j > 0 && i < 2458 && j < 3292)
			{
				b[i][j] = ( pic[i][j] + pic[i-2][j] + pic[i+2][j] + pic[i][j-2] + pic[i][j+2] ) / 5;
			}
		}
	...
	for( i = 1; i <2460 ; i = i+2)
		for( j = 6 ; j<3293; j = j+2)
		{
			...
			// Improved interpolation for B region
			if(i > 0 && j > 0 && i < 2458 && j < 3292)
			{
				b[i][j] = ( pic[i][j] + pic[i-2][j] + pic[i+2][j] + pic[i][j-2] + pic[i][j+2] ) / 5;
			}
